...
@test '#_install_tmux_plugin_manager should return 0 if determin_update_type_of_repository returns GIT_UPDATE_TYPE_JUST_PULL then git pull was succeeded' {
    stub pushd; stub popd
    stub_and_eval determin_update_type_of_repository '{ return $GIT_UPDATE_TYPE_JUST_PULL; }'
    stub git
    run _install_tmux_plugin_manager "${HOME}/.tmux/plugins/tpm"
    ...
    stub_called_with_exactly_times determin_update_type_of_repository 1 "${HOME}/.tmux/plugins/tpm" "origin" "$URL_OF_TMUX_PLUGIN" "master" 1
    stub_called_with_exactly_times git 1 pull origin HEAD
    stub_called_with_exactly_times pushd 1 "${HOME}/.tmux/plugins/tpm"
}

@test '#_install_tmux_plugin_manager should return 0 if determin_update_type_of_repository returns GIT_UPDATE_TYPE_JUST_PULL then git pull was failed' {
    stub pushd; stub popd
    stub_and_eval determin_update_type_of_repository '{ return $GIT_UPDATE_TYPE_JUST_PULL; }'
    stub_and_eval git '{ return 1; }'
    run _install_tmux_plugin_manager "${HOME}/.tmux/plugins/tpm"
    ...
    stub_called_with_exactly_times determin_update_type_of_repository 1 "${HOME}/.tmux/plugins/tpm" "origin" "$URL_OF_TMUX_PLUGIN" "master" 1
    stub_called_with_exactly_times git 1 pull origin HEAD
    stub_called_with_exactly_times logger_err 1 "Fatiled to pull repository ${URL_OF_TMUX_PLUGIN}"
    stub_called_with_exactly_times pushd 1 "${HOME}/.tmux/plugins/tpm"
}

@test '#_install_tmux_plugin_manager should return 1 if determin_update_type_of_repository returns unknown code' {
    stub pushd; stub popd
    stub_and_eval determin_update_type_of_repository '{ return 254; }'
    run _install_tmux_plugin_manager "${HOME}/.tmux/plugins/tpm"
    ...
    stub_called_with_exactly_times determin_update_type_of_repository 1 "${HOME}/.tmux/plugins/tpm" "origin" "$URL_OF_TMUX_PLUGIN" "master" 1
    stub_called_with_exactly_times logger_err 1 "Some error occured when installing ${URL_OF_TMUX_PLUGIN}"
}
